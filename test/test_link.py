...
def test_get_original_link(test_link):
    response = client.get('link/shorten-link/get-original',
                          params={'shortened_url_link': 'https://scissors.com/qwertyuiopas'})
...
def test_get_original_link_broken_link(test_link):
    response = client.get('link/shorten-link/get-original',
                          params={'shortened_url_link': 'https://scissors.com/qwertyuiopar'})
